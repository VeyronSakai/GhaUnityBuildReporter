            ...
            var buildSteps = new[]
            {
                ...
                new BuildStep("Test Build Step3", new System.TimeSpan(0, 0, 2, 3, 123),
                    new[]
                    {
                        ...
                        new BuildStepMessage(LogType.Warning, "This is Test Step3 Warning 2"), new BuildStepMessage(
                            LogType.Warning, "This is Test Step3 Warning 3\nNew-line message."),
                        new BuildStepMessage(LogType.Error,
                            "This is Test Step3 Error\n\nNew-line message.")
                    }, 1),
